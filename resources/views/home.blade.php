...
<div class="position-relative mb-5">
    ...
    <img src="{{ asset('assets/images/banner.jpg') }}" class="w-100" style="height: 450px; object-fit: cover;" alt="Banner">

    <!-- Filtro encima de la imagen -->
    <div class="position-absolute top-50 start-50 translate-middle bg-dark bg-opacity-75 text-white p-4 rounded shadow" style="width: 90%; max-width: 700px;">
...
<section class="mb-5">
  ...
  <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
    @foreach ([
      ['titulo' => 'Asistente Administrativo', 'ubicacion' => 'Tegucigalpa, Honduras', 'fecha' => '1 día', 'actividad'=>'Financiero', 'categoria'=>'Administración'],
      ['titulo' => 'Técnico en Soporte',     'ubicacion' => 'Santa Ana, Honduras',   'fecha' => '2 días', 'actividad'=>'Soporte TI', 'categoria'=>'Tecnología'],
      ['titulo' => 'Diseñador Gráfico',      'ubicacion' => 'La Ceiba, Honduras',    'fecha' => '3 días', 'actividad'=>'Creativo', 'categoria'=>'Diseño'],
      ['titulo' => 'Contador General',       'ubicacion' => 'Tegucigalpa, Honduras', 'fecha' => '4 días', 'actividad'=>'Financiero', 'categoria'=>'Contabilidad'],
      ['titulo' => 'Programador Laravel',    'ubicacion' => 'San Pedro Sula, Honduras','fecha'=>'5 días','actividad'=>'Desarrollo', 'categoria'=>'Tecnología'],
      ['titulo' => 'Recepcionista',          'ubicacion' => 'Comayagua, Honduras',   'fecha' => '6 días', 'actividad'=>'Atención al cliente', 'categoria'=>'Administración'],
    ] as $plaza)
...
<section class="mb-5">
  <style>
    ...
    .vm-card:hover { transform: translateY(-2px); box-shadow:0 10px 24px rgba(0,0,0,.06); }
    .vm-title {
    ...
    .vm-text { color:#4b5563; line-height:1.6; margin:0; }
    .vm-section-title{
      font-weight:800; color:#111827; text-align:center; margin-bottom:.25rem;
    }
    .vm-section-sub{ color:#6b7280; text-align:center; margin-bottom:1.5rem; }
    @media (min-width:992px){ .vm-grid{display:grid; grid-template-columns:repeat(3,minmax(0,1fr)); gap:1.25rem;} }
    @media (max-width:991.98px){ .vm-grid > *{ margin-bottom:1rem; } }
  </style>
...
<section class="mb-5">
  <style>
    ...
    .testi-text { font-size:.85rem; line-height:1.3rem; }

    .testi-author {
      position:absolute; left:50%; bottom:.6rem; transform:translateX(-50%);
      display:flex; align-items:center; gap:.5rem;
      background:#fff; border:1px solid #e5e7eb;
      border-radius:.75rem; padding:.3rem .6rem;
    ...
    .testi-role {font-size:.7rem; color:#374151;}

    /* solo bordes de color (pasteles) */
    .carousel-track .testi-bubble:nth-child(5n+1){
      border:3px solid #93c5fd; /* azul pastel */
    }
    .carousel-track .testi-bubble:nth-child(5n+1) .testi-avatar{ background:#3b82f6; }

    .carousel-track .testi-bubble:nth-child(5n+2){
      border:3px solid #6ee7b7; /* verde pastel */
    }
    .carousel-track .testi-bubble:nth-child(5n+2) .testi-avatar{ background:#10b981; }

    .carousel-track .testi-bubble:nth-child(5n+3){
      border:3px solid #fde68a; /* amarillo pastel */
    }
    .carousel-track .testi-bubble:nth-child(5n+3) .testi-avatar{ background:#f59e0b; }

    .carousel-track .testi-bubble:nth-child(5n+4){
      border:3px solid #c4b5fd; /* morado lavanda */
    }
    .carousel-track .testi-bubble:nth-child(5n+4) .testi-avatar{ background:#8b5cf6; }

    .carousel-track .testi-bubble:nth-child(5n+5){
      border:3px solid #fbcfe8; /* rosa pastel */
    }
    .carousel-track .testi-bubble:nth-child(5n+5) .testi-avatar{ background:#ec4899; }

    .btn-matte {
      background:#374151; color:#fff; border:none; border-radius:8px;
      padding:.6rem 1.2rem; font-weight:500; transition:.2s;
    }
    .btn-matte:hover { background:#111827; }
  </style>
  ...
  <div class="carousel-wrapper">
    <div id="comentariosTrack" class="carousel-track">
      @foreach([
        ['txt'=>'“Encontré empleo en menos de dos semanas. El proceso fue claro y rápido.”','name'=>'María Gómez','role'=>'Diseñadora'],
        ['txt'=>'“Las alertas de plazas me ayudaron a aplicar a tiempo. Súper recomendado.”','name'=>'Carlos Pérez','role'=>'Técnico Soporte'],
        ['txt'=>'“Me gustó la facilidad para crear mi CV y postularme desde el celular.”','name'=>'Lucía Torres','role'=>'Administrativa'],
        ['txt'=>'“Gracias a la plataforma pude encontrar una plaza en mi ciudad sin complicaciones.”','name'=>'Juan Ramírez','role'=>'Contador'],
        ['txt'=>'“Excelente sitio, fácil de usar y con muchas oportunidades.”','name'=>'Ana Martínez','role'=>'Programadora'],
        ['txt'=>'“El registro fue sencillo y pude subir mi CV en minutos.”','name'=>'Pedro López','role'=>'Ingeniero'],
      ] as $t)
