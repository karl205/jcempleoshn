...
@section('content')
<h2 class="mb-4 text-primary">Catálogos del Sistema</h2>

<div style="max-height: 80vh; overflow-y: auto;" class="p-3 bg-light border rounded">
    <div class="row g-4">
...
<div class="col-md-6">
    @include('admin.catalogos._catalogo', [
        ...
        'catalogo' => 'cargos',   {{-- <- bandera para que en el parcial salga el select vacío --}}
        'items' => ['Programador Web', 'Asistente'],
