        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 bg-dark text-white p-4 min-vh-100">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-2">
                        <a class="nav-link text-white" href="{{ route('admin.plazas') }}"><i
                                class="bi bi-briefcase-fill me-2"></i>Gestionar Plazas</a>
                    </li>
                    <li class="nav-item mb-2">
                    ...
                    <li class="nav-item mb-2">
                        <a class="nav-link text-white d-flex justify-content-between align-items-center"
                            data-bs-toggle="collapse" href="#seguridadSubmenu" role="button"
