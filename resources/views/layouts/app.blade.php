...
<head>
    ...
    .card-hover:hover {
        ...
        transform: translateY(-4px); /* efecto de "levantar" la tarjeta */
    }
</style>
...
<body>
    ...
    <span style="font-size: 1.9rem;">J</span><span style="color: orange; font-size: 1.9rem;">C</span> Empleos Honduras
</a>
